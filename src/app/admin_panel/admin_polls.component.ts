...
@Component({
  ...
  templateUrl: './admin_polls.component.html',   /* previous  './polls_page.component.html', */       /* html için bu sorun çıkarıyor */
  styleUrls: ['./admin_polls.component.css']     /* previous  ['./polls_page.component.css'] */


}) 
export class AdminPollsComponent{                   /* previous PollsPageComponent */
